...
return <Navbar collapseOnSelect expand="lg" className = "color-nav" variant = "dark">
      <Navbar.Brand className = "brand-nav" href={"/" + _.lowerCase("Jmuetr")}><img className = "logo-pic" src = {LogoPic} alt = "jmulogo"></img>Technical Resources</Navbar.Brand>
      <Navbar.Toggle aria-controls="basic-navbar-nav" />
      <Navbar.Collapse id="basic-navbar-nav">
        <Nav className="ml-auto">
          <Nav.Link href={"/" + _.lowerCase("Jmuetr")}><i className = "home fas fa-home"></i></Nav.Link>
          <Nav.Link href = {"/" + _.lowerCase("Jmuetr") + "/#/" + _.lowerCase("Github")}>Github</Nav.Link>
          <HoverDropdown />
